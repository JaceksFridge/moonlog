...
const MiniChartHappiness = ({ data }) => {

    const [chartId] = useState(`chart-happiness${Math.random().toString(36).substr(2, 9)}`);
    let root
    useEffect(() => {
        am5.ready(() => {
...
export default MiniChartHappiness
